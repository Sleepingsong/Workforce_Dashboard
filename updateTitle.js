...
updateChartTitle("LoginStatisticsChart-title", "สถิติข้อมูลจำนวนครั้งการ Login เข้าใช้งานระบบ");
updateChartTitle("LoginByUserChart-title", "สถิติข้อมูลจำนวนครั้งการ Login ของผู้ใช้งานระบบ");
